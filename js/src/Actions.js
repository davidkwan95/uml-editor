...
Actions.prototype.init = function()
{
	...
	this.addAction('save', function() { saveFile(ui, false); }, null, null, 'Ctrl+S').isEnabled = isGraphEnabled;
	this.addAction('saveAs...', function() { saveFile(ui, true); }, null, null, 'Ctrl+Shift+S').isEnabled = isGraphEnabled;
